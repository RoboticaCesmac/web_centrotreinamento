...
/**
 * Mensagens de erro do firebase traduzidas
 * https://gist.github.com/Albejr/a38cdeac247ef177986c99629680afb4?permalink_comment_id=3163265#gistcomment-3163265
 */
const errosFirebase = {
...
/**
 * Traduz o erro do firebase para PT/BR
 * https://gist.github.com/Albejr/a38cdeac247ef177986c99629680afb4?permalink_comment_id=3174712#gistcomment-3174712
 * @param erro
 */
export function traduzirErroFirebase(erro?: FirebaseError & { code?: string }) {
    if (typeof erro === 'object' && typeof erro.code === 'string' && erro.code in errosFirebase){
        erro.message = (errosFirebase as any)[erro.code];
        return (errosFirebase as any)[erro.code];
    }
